@if ($paginator->hasPages())
    <ul class="pagination {{ isset($ulClass) ? join(" ",$ulClass) : "" }}" role="navigation">
        {{-- Previous Page Link --}}
        ...
        @foreach ($elements as $element)
            ...
            @if (is_string($element))
                <li class="page-item disabled three-dots" aria-disabled="true"><span class="page-link">{{ $element }}</span></li>
            @endif
